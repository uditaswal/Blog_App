...
import { updateProfileImg, deleteProfileImage, updateUserProfileData, deleteUserOwnAccount, getUserOwnAccount } from "../controllers/user.controller.js"
...
userRouter.get('/me', protect, getUserOwnAccount);
